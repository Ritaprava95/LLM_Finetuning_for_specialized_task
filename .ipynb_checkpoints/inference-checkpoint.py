...
# alternate way is to load the merged model
from transformers import AutoModelForCausalLM
...
peft_tokenizer_2 = AutoTokenizer.from_pretrained("../models/merged",trust_remote_code=True,padding_side="left",add_eos_token=True,add_bos_token=True,use_fast=False)
